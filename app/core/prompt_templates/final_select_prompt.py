...
def get_selection_prompt() -> ChatPromptTemplate:
    ...
    example_output = [
        ...
        },
        {
            ...
            "tags": ["#인지도제고", "#난이도하", "#마케팅"],
            "related_swot": ["W", "O"],
            "final_reason": "우수한 가성비라는 확실한 강점이 있음에도 불구하고, 현재 온라인 리뷰 수가 경쟁사의 20% 수준에 머물러 있다는 약점은 잠재 고객을 이탈시키는 가장 큰 병목 구간입니다. 저녁 시간대 방문객이 증가하는 기회 요인을 활용해 실질적인 혜택인 할인권을 제공하여 자발적인 리뷰 작성을 유도함으로써, 디지털 신뢰도의 핵심인 '사회적 증거'를 단기간에 확보해야 합니다. 이 전략은 가장 적은 비용으로 온라인 검색 시의 전환율을 획기적으로 개선하여 장기적인 매장 인지도를 탄탄하게 구축해 줄 것입니다."
        },
        {
            "id": 3,
            "title": "지역 내 '최저가 보상제' 및 단골 혜택 강화",
            "tags": ["#신규고객", "#난이도중", "#고객관리"],
            "related_swot": ["S", "T"],
            "final_reason": "반경 500m 이내에 150개의 업체가 밀집하여 경쟁이 치열한 과포화 상태라는 위협 요소에서 살아남기 위해서는 고객에게 '이곳이 가장 저렴하다'는 강력한 확신을 심어주어야 합니다. 매장의 장점인 우수한 기존 객단가를 '최저가 보상제'라는 마케팅 언어로 공식화하여 경쟁사의 유입 독점을 차단하고, 한번 방문한 고객을 단골로 전환시키는 시스템을 병행해야 합니다. 브랜딩을 위한 운영 공수가 일부 발생하지만, 이는 치열한 출혈 경쟁 속에서 매장의 독보적인 포지션을 구축하고 지속 가능한 생존력을 확보하는 필수적인 방어 전략입니다."
        }
    ]
